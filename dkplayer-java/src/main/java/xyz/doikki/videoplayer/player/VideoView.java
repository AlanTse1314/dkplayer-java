...
import xyz.doikki.videoplayer.sniffer.VideoSniffer;
import xyz.doikki.videoplayer.source.DataSource;
import xyz.doikki.videoplayer.util.LogUtility;
...
//        boolean sniffing,
//        int timeOut)
        DataSource dataSource = new DataSource(url,title,true, null, false,false,8);
        setUp(dataSource);
    }
