...
import xyz.doikki.videoplayer.videocontroller.adapter.TagAdapter;
...
public class TitleView extends FrameLayout implements IControlComponent {
    ...
    public class CustomFullScreenPopup extends FullScreenPopupView {
        ...
        protected void init() {
            super.init();
            findViewById(R.id.ll_pop).setOnClickListener(new OnClickListener() { // from class: StandardVideoController.j.a.d.a
