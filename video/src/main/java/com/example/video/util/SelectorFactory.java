...
public class SelectorFactory {
    ...
    public static final class GeneralSelector {
        ...
        public GeneralSelector setPressedDrawable(@ColorInt int color) {
        ...
        public GeneralSelector setSelectedDrawable(@ColorInt int color) {
            GradientDrawable drawableBlue = new GradientDrawable();
            drawableBlue.setShape(GradientDrawable.RECTANGLE);
            drawableBlue.setColor(color);
            mSelectedDrawable = drawableBlue;
            hasSetSelectedDrawable = true;
            return this;
        }
        ...
        public GeneralSelector setFocusedDrawableId(@ColorInt int color) {
            GradientDrawable drawableBlue = new GradientDrawable();
            drawableBlue.setShape(GradientDrawable.RECTANGLE);
            drawableBlue.setColor(color);
            mFocusedDrawable = drawableBlue;
            hasSetFocusedDrawable = true;
            return this;
        }
    ...
    public static GradientDrawable cornerDrawable(GradientDrawable.Orientation angle, int endColor,  int startColor) {
        int colors[] = {startColor,  endColor};
        GradientDrawable gradientDrawable = new GradientDrawable(angle, colors);
