package com.alan.banner.viewpage;
...
public class AutoScrollViewPager extends ViewPager {
    ...
    public boolean                stopScrollWhenTouch         = true;
    /** how to process when sliding at the last or first item, default is {@link #SLIDE_BORDER_MODE_NONE} **/
    public int                    slideBorderMode             = SLIDE_BORDER_MODE_NONE;
    /** whether animating when auto scroll at the last or first item **/
    public boolean                isBorderAnimation           = true;
    /** scroll factor for auto scroll animation, default is 1.0 **/
    public double                 autoScrollFactor            = 1.0;
    /** scroll factor for swipe scroll animation, default is 1.0 **/
    public double                 swipeScrollFactor           = 1.0;

    public Handler                handler;
    public boolean                isAutoScroll                = false;
    public boolean                isStopByTouch               = false;
    public float                  touchX                      = 0f, downX = 0f;
